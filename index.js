...
app.use(cors({origin: ['http://localhost:3000', 'https://yonela-johannes.github.io', 'https://yonela-johannes.github.io/mysite', 'https://johannesyonela.engineer', 'http://localhost:19006'], credentials: true}));
